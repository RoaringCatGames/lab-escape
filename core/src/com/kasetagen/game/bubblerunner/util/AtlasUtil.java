...
public class AtlasUtil {
    ...
    public static final String ANI_OPTIONS_CHARSELECT = "screens/options/Edyn_Select_Small";
    ...
    public static final String ANI_OPTIONS_MUSIC = "screens/options/Edyn_Select_Small";
    public static final String ANI_OPTIONS_SFX = "screens/options/Edyn_Select_Small";
    ...
    public static final String ANI_FRED_PUNCH = "player/Male_Punch";
    ...
    public static final String ANI_WALL_LASER_L = "walls/Laser_Wall_Left";
